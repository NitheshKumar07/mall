...
const handleAddtoCart = () => {
  ...
  <div className='soloLaptopDetails-container'>
    ...
    <div className='sizeChart'>
        <p>Select Size:</p>
        <input type='radio' value='jeans28' name='jeansSize' id='size28'/>
        <label htmlFor='size28'>28</label>
        <input type='radio' value='jeans30' name='jeansSize' id='size30'/>
        <label htmlFor='size30'>30</label>
        <input type='radio' value='jeans32' name='jeansSize' id='size32'/>
        <label htmlFor='size32'>32</label>
        <input type='radio' value='jeans34' name='jeansSize' id='size34'/>
        <label htmlFor='size34'>34</label>
        <input type='radio' value='jeans36' name='jeansSize' id='size36'/>
