...
<div className='super-box'  style={{width:'75%'}}>
{ (filteredProducts.length > 0 ? filteredProducts : mobile).map((eachMobile,index)  => {
  return (
    ...
    <div className='mobileItemImg-container mobileItemImg-containerSMALL'>
    ...
    <div className='handbagItemDetails-container'>
      ...
      <a className='chudidarItem-name tvNAME' id='handbagItem-name-ID' onClick={()=>navigateSoloLaptop(eachMobile._id)}>{eachMobile.title}</a>
