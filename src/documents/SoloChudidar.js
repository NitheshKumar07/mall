...
const handleAddtoCart = () => {
  ...
  <div className='soloLaptopDetails-container'>
    ...
    <div className='sizeChart'>
        <p>Select Size:</p>
        <input type='radio' value='7' name='ShoeSize' id='size7'/>
        <label htmlFor='size7'>7</label>
        <input type='radio' value='8' name='ShoeSize' id='size8'/>
        <label htmlFor='size8'>8</label>
        <input type='radio' value='9' name='ShoeSize' id='size9'/>
        <label htmlFor='size9'>9</label>
        <input type='radio' value='10' name='ShoeSize' id='size10'/>
        <label htmlFor='size10'>10</label>
        <input type='radio' value='11' name='ShoeSize' id='size11'/>
